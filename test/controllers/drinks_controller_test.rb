...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { description: @drink.description, source: @drink.source, steps: @drink.steps, string: @drink.string, title: @drink.title } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { description: @drink.description, source: @drink.source, steps: @drink.steps, string: @drink.string, title: @drink.title } }, as: :json
    assert_response 200
  end
