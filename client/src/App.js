...
class App extends Component {
  ...
  render() {
   ...
   return drinks ?
   <Container text><Header as='h2' icon textAlign='center' color='teal'>
   ...
   <Header.Content>
     ...
     <Button.Group color='teal' fluid widths={drinks.length}>
      {Object.keys(drinks).map(key => {
        ...
        {drinks[key].title}</Button>
      })}</Button.Group> : <Container textAlign='center'> No drinks found</Container>
    }
    <Divider section />
        {drink &&
          <Container>
